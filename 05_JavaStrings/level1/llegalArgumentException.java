...
public class llegalArgumentException {
    ...
    public static void demonstrateStringIndexOutOfBoundsException(String str) {
        try {
            System.out.println("Attempting to access out-of-bounds index...");
            System.out.println(str.charAt(str.length()));
        } catch (StringIndexOutOfBoundsException e) {
    ...
    public static void main(String[] args) {
        ...
        demonstrateStringIndexOutOfBoundsException(str);
